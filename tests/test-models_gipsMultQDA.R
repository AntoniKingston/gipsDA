...
expect_true(inherits(fit_formula, "gipsmultqda"))
...
expect_true(inherits(fit_matrix, "gipsmultqda"))
...
expect_true(inherits(fit_df, "gipsmultqda"))
...
expect_true(inherits(fit_opts, "gipsmultqda"))
...
# Check if it returns the standard QDA prediction components
