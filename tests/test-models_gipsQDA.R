...
expect_true(inherits(fit_formula, "gipsqda"))
...
expect_true(inherits(fit_matrix, "gipsqda"))
...
expect_true(inherits(fit_df, "gipsqda"))
...
expect_true(inherits(fit_opts, "gipsqda"))
